  ...
  return (
    <footer className="bg-gradient-to-br from-brand-navy-3 via-brand-navy to-brand-navy-2 text-pearl-shine relative overflow-hidden" role="contentinfo">
      ...
      <div
        ...
        style={{ background: 'radial-gradient(circle, rgba(59,95,232,0.5) 0%, transparent 70%)' }}
      />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3 text-sm">
              <a href={`tel:${COMPANY_INFO.phone}`} className="flex items-center gap-2 text-white/70 hover:text-white transition-colors">
                <Phone className="w-4 h-4" aria-hidden="true" />
                {COMPANY_INFO.phone}
              </a>
              <a href={`mailto:${COMPANY_INFO.email}`} className="flex items-center gap-2 text-white/70 hover:text-white transition-colors">
          ...
          {/* Suite Links */}
          <div>
            <h3 className="font-mono text-xs uppercase tracking-wider text-brand-violet mb-4">Suite</h3>
          ...
          {/* More Suite Links */}
          <div>
            <h3 className="font-mono text-xs uppercase tracking-wider text-brand-violet mb-4">Altre Suite</h3>
            <ul className="space-y-2">
          ...
          {/* Company Links */}
          <div>
            <h3 className="font-mono text-xs uppercase tracking-wider text-brand-violet mb-4">Azienda</h3>
            <ul className="space-y-2">
              <li><Link href="/azienda/" className="text-sm text-white/70 hover:text-white transition-colors">Chi siamo</Link></li>
              <li><Link href="/piattaforma/" className="text-sm text-white/70 hover:text-white transition-colors">Piattaforma</Link></li>
              <li><Link href="/integrazioni/" className="text-sm text-white/70 hover:text-white transition-colors">Integrazioni</Link></li>
              <li><Link href="/supporto/" className="text-sm text-white/70 hover:text-white transition-colors">Supporto</Link></li>
